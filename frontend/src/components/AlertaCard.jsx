...
const severidadConfig = {
  critical: { bg: 'bg-red-900/50', border: 'border-red-500', text: 'text-red-400' },
  high: { bg: 'bg-orange-900/50', border: 'border-orange-500', text: 'text-orange-400' },
  medium: { bg: 'bg-yellow-900/50', border: 'border-yellow-500', text: 'text-yellow-400' },
  low: { bg: 'bg-green-900/50', border: 'border-green-500', text: 'text-green-400' }
};
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-gray-500 text-xs">{traducirCategoria(alerta.categoria)}</span>
          </div>
